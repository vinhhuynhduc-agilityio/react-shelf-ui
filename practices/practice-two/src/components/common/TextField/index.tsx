...
export const TextField = <T extends FieldValues>({
  ...
  const labelClass = clsx(
    ["w-30", "w-32"].includes(labelWidth) ? labelWidth : "w-30",
  ...
  const inputBaseClass =
    "text-sm sm:text-base md:text-lg placeholder:text-sm sm:placeholder:text-base md:placeholder:text-[17.5px]";
  ...
  const textareaClass = clsx(
    "border rounded-md w-full resize-none h-[158px] p-2",
    inputBaseClass,
    disabled && "bg-gray-100 cursor-not-allowed"
  );
