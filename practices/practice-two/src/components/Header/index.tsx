...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center p-4 relative">
      {/* Search Bar */}
      <div
        className="relative flex items-center bg-white border border-gray-300 rounded-full h-[40px] w-[600px] overflow-hidden"
        ref={filterButtonRef}
      >
        <button
          onClick={() => setFilterMenuOpen(!isFilterMenuOpen)}
          className="px-3 py-2 bg-[#F5F5F5] text-black border-r flex items-center gap-2"
        >
          {selectedFilter}
