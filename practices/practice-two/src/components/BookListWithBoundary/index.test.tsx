...
import BookListWithBoundary from "./index";
...
jest.mock("@/components", () => ({
  ...
  ErrorBoundary: jest.requireActual("../ErrorBoundary").ErrorBoundary,
  ParagraphMessage: ({
    text,
    className,
  }: {
...
describe("BookListWithBoundary", () => {
  ...
  it("renders fallback ParagraphMessage when error is thrown in BookHomeList", () => {
    ...
    render(<BookListWithBoundary books={MOCK_BOOKS} title="Favourites" />);
