...
const FavouritePage: React.FC = () => {
  ...
  if (!filteredBooks.length) return <p className="text-gray-600">No books in your favourites.</p>;
  ...
  const handleClickBack = () => navigate("/my-shelf");
  ...
  return (
    <>
      <BackToResultButton
        ...
        title="Back"
      />
      <h1 className="md:text-[25px] text-[20px] font-semibold text-[#4D4D4D] mb-6">Your Favourite</h1>
      <div className="overflow-x-auto text-[#4D4D4D]">
        <HeaderRow />
        <div className="space-y-4 mt-4">
          {filteredBooks.length === 0 ? (
            <p className="text-xl font-semibold text-red-400 mt-9 ml-8">No books found in your favourites.</p>
          ) : (
